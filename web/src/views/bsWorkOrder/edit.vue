<template>
  <div>
    <n-modal v-model:show="showModal" :mask-closable="false" :show-icon="false" preset="dialog"
      transform-origin="center" :title="formValue.id > 0 ? '编辑工单管理 #' + formValue.id : '添加工单管理'" :style="{
        width: dialogWidth,
      }">
        ...
        <n-spin :show="loading" description="请稍候...">
          <n-form ref="formRef" :model="formValue" :rules="rules"
            ...
            <n-grid cols="2" responsive="screen">
              ...
              <n-gi span="1">
                <n-form-item label="联系方式" path="customerContact">
              ...
              <n-gi span="1">
                <n-form-item label="对接人" path="customerPerson">
...
import { List as ListUser } from '@/api/org/user';
import { State as UserState } from '@/views/org/user/model'
...
async function initUserList() {
  ...
  userOptions.value = list.map((item: UserState) => ({
